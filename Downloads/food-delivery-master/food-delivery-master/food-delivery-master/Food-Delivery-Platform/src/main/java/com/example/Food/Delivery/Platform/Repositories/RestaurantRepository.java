...
public interface RestaurantRepository extends JpaRepository<Restaurant, Long> {
    @Query("""
        ...
        AND c.isActive = true
    """)
    List<ComboMeal> findComboMealsByRestaurantId(@Param("restaurantId") Long restaurantId);
    ...
    @Query("""
        ...
        AND c.isActive = true
    """)
    List<ComboMeal> findAvailableComboMeals(@Param("restaurantId") Long restaurantId);
