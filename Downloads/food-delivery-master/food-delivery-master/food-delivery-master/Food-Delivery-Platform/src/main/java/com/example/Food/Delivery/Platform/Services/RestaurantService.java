...
public class RestaurantService {
    ...
    @Transactional
    public void toggleAcceptingOrders(Long restaurantId, boolean status) {
    ...
    @Transactional
    public void updateDeliveryFee(long restaurantId, double newFee) {
    ...
    @Transactional
    public void updateMinOrderAmount(Long restaurantId, double minOrderAmount) {
