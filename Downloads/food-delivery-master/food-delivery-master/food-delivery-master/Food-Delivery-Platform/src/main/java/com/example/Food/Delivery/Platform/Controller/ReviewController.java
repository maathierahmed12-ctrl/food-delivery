...
public class ReviewController {
    ...
    public ResponseEntity<Double> getRestaurantAverage(@PathVariable Long restaurantId) {
    ...
    public ResponseEntity<Double> getDriverAverage(@PathVariable Long driverId) {
